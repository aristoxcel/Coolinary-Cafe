  ...
  return (
   <div className="grid grid-cols-1 md:grid-cols-2 gap-20 py-24">
     <div className="flex flex-col justify-center items-center space-y-4">
        <h1 className="text-2xl lg:text-3xl font-pacific text-red-500">American Restaurant</h1>
        <Headline
        text={'Welcome'}
    ...
    <div className="md:w-4/6 w-full"><img src={"food.jpg"} alt="" className="rounded-2xl"/></div>
   </div>
  )
}
